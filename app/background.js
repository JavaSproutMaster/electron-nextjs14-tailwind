...
electron__WEBPACK_IMPORTED_MODULE_0__.ipcMain.on('login', async (event, email, password) => {
  // login 
});
electron__WEBPACK_IMPORTED_MODULE_0__.ipcMain.on('logout', async event => {
  // logout 
});
electron__WEBPACK_IMPORTED_MODULE_0__.ipcMain.on('signup', async (event, username, email, password) => {
  // signup 
});
electron__WEBPACK_IMPORTED_MODULE_0__.ipcMain.on('usertask', async (event, email, password) => {
  // usertask 
});
electron__WEBPACK_IMPORTED_MODULE_0__.ipcMain.on('signup', async (event, email, password) => {
  // signup 
});
})();
